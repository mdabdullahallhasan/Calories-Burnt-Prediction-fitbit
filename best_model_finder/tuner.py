...
class Model_Finder:
    ...
    def get_best_params_for_random_forest(self,train_x,train_y):
        ...
        try:
            ...
            self.param_grid = {"n_estimators": [10, 100,200,300,400,500,600,700,800,900,1000], "criterion": ['mse'],
    ...
    def get_best_params_for_xgboost(self,train_x,train_y):
        ...
        try:
            ...
            self.param_grid_xgboost = {
                ...
                'max_depth': [3, 5, 10, 20],
                'n_estimators': [10, 50, 100, 200,250,300,700,900],
    ...
    def get_best_model(self,train_x,train_y,test_x,test_y):
        ...
        try:
            ...
            self.prediction_Random_Forest_Reg_error = r2_score(test_y,self.self.prediction_Random_Forest_reg)
